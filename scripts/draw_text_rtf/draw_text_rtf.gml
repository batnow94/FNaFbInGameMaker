/// @description draw_text_rtf(x, y, string, regular_font, bold_font, italic_font, bold_italic_font)
/// @param x
/// @param  y
/// @param  string
/// @param  regular_font
/// @param  bold_font
/// @param  italic_font
/// @param  bold_italic_font
function draw_text_rtf(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
	/*
	...
	*/
	...
	while(i<string_length(str)){
	    i++;
	    if(string_copy(str, i, 1) == "#"){next_x = 0; next_y += string_height(string_hash_to_newline("#"));}
	    else if(next_x>room_width){next_x = 0; next_y += string_height(string_hash_to_newline("#"));}
	    if !is_undefined(ds_map_find_value(col_map, i)) draw_set_color(ds_map_find_value(col_map, i));
	    switch(ds_map_find_value(rtf_map, i)){
	        case 1:
	        draw_set_font(f_r);
	        draw_text(rtf_x + next_x, rtf_y + next_y, string_hash_to_newline(string_copy(str, i, 1)));
	        next_x += string_width(string_hash_to_newline(string_copy(str, i, 1)));
	        break;
	        case 2:
	        draw_set_font(f_b);
	        draw_text(rtf_x + next_x, rtf_y + next_y, string_hash_to_newline(string_copy(str, i, 1)));
