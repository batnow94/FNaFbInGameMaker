/// @description bbcode_decode(bbcode, formatting ds_list, colour ds_list)
/// @param bbcode
/// @param  formatting ds_list
/// @param  colour ds_list
function bbcode_decode(argument0, argument1, argument2) {
	/*
