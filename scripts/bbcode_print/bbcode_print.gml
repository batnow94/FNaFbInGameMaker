/// @description bbcode_print(x, y, string, ds_formatting, ds_colour, regular_font, bold_font, italic_font, bold_italic_font)
/// @param x
/// @param  y
/// @param  string
/// @param  ds_formatting
...
function bbcode_print(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8) {
	/*
	...
	while(i<=string_length(str)){
	    ...
	    if dnow {
	        ...
	        switch(dmode){
	            case 1:
	                draw_set_font(f_r);
	                draw_text(rtf_x + next_x, rtf_y + next_y, string_hash_to_newline(dnowstr));
	                next_x += string_width(string_hash_to_newline(dnowstr));
	            break;
	            case 2:
	                draw_set_font(f_b);
	                draw_text(rtf_x + next_x, rtf_y + next_y, string_hash_to_newline(dnowstr));
